...
public class ExclusiveGatewayBPMNJsAdapter implements BPMNJsAdapter {
    ...
    public BPMNDiagramElement addElement(BPMNDiagram bpmnDiagram, String conditionalFlowName, ElementIdGenerator elementIdGenerator, Position currentPosition) {
        ...
        bpmnDiagram.setCurrentElement(createElementWithCustomLabelAndSequenceFlow(ExclusiveGateway.class, bpmnDiagram, exclusiveGateway));
        ...
        if (!(bpmnDiagram.getCurrentElement().getFlowNode() instanceof EndEvent)) {
            ...
            bpmnDiagram.setCurrentElement(createElementWithSequenceFlow(ExclusiveGateway.class, bpmnDiagram, balanceExclusiveGateway));
        }
