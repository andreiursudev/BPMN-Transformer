...
public class SendInvoiceCamelAdapter implements CamelAdapter {
    private String message;

    public SendInvoiceCamelAdapter(String message) {
        this.message = message;
    }

    @Override
    public void adapt(ProcessorDefinition processorDefinition, BPMNToCamelDictionary dictionary) {
        processorDefinition.log(String.format(message,  "${header.CamelFileName}"));
    }
}
